...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
            @vite(['resources/css/app.css', 'resources/js/app.js','resources/js/paneles.js','resources/js/add_panel.js'])
        @else
            <style>
            ...
            <div class="w-full h-full overflow-y-auto barpag">
                <div class="w-full h-180">
                    <div class="h-15 w-full flex justify-center">
                        <input class="bgcol2 transition-all lg:w-120 lg:text-lg xl:w-180 xl:text-xl m-3 text-xs w-2/4 h-10 mb-15 col7 p-2" placeholder="Busca un Registro"/>
                        <button class="h-10 cursor-pointer transition-colors aspect-square perfil-div-nav rounded-full flex items-center justify-center m-3">
